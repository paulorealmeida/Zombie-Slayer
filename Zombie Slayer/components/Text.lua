...
--[[
    ...
    -->fade_out: boolean - Should text fade out (optional)
        default: false
    -->wrap_width: number - We should text break (optional)
...
function Text(text,x,y,font_size,fade_in,fade_out,wrap_width,align,opacity,TEXT_FADE_DUR)
    ...
    TEXT_FADE_DUR = TEXT_FADE_DUR or 5
